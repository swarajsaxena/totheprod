  ...
  return (
    <kbd
      className={cn(
        ...
        "in-data-[slot=tooltip-content]:bg-background-foreground/20 in-data-[slot=tooltip-content]:text-primary dark:in-data-[slot=tooltip-content]:bg-background-foreground/10",
        className
      )}
      data-slot="kbd"
      {...props}
